...
// import SarthiLogo from "../assets/images/sarthi.png"
// import myvideo from '../assets/images/infinity-loop.mp4'
...
const Section1 = () => {
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      >
        <img src={SarthiLogo} style={{float:"right"}}/>

        {/* <iframe style={{margin:'100px 0 0 450px' }} src="https://giphy.com/embed/3o7btPFYOPrCnWabmg" width="100%" height="450" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/animation-loop-tao-3o7btPFYOPrCnWabmg">via GIPHY</a></p> */}
